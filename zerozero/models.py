...
class QueryReport(models.Model):
    ...
    fields = models.JSONField(blank=True, null=True, default=list)
    order = models.JSONField(blank=True, null=True, default=list)
    where = models.JSONField(blank=True, null=True, default=dict)
